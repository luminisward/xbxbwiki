...
class EnemyPageBuilder(DokuwikiTextBuilder):
    ...
    coreCrystalDropRate = {
        ...
        '12': '|普通核心水晶|100%|\n|稀有核心水晶|50%|',
        '13': '|普通核心水晶|100%|\n|稀有核心水晶|100%|',
        '14': '|普通核心水晶|20%、第一次击杀必掉|\n|稀有核心水晶|13%、第一次击杀必掉|\n|史诗核心水晶|3.9%|',
        '15': '|稀有核心水晶|50%、第一次击杀必掉|\n|史诗核心水晶|10%、第一次击杀必掉|',
        '16': '|普通核心水晶|100%|\n|稀有核心水晶|100%|\n|史诗核心水晶|5%|',
        'b1': '|普通核心水晶×3|100%|\n|稀有核心水晶|100%|',
        'b2': '|普通核心水晶×2|100%|\n|稀有核心水晶|100%|',
        'b3': '|稀有核心水晶|100%|',
    ...
    def normalOutput(self):
        ...
        # 配图
        self.appendLine('{{{{ :敌人:{}.jpg|}}}}'.format(dataDict['简中']))
        self.appendLine('')
        ...
        # 核心水晶掉率
        text = self.buildHeader(3, '核心水晶掉率')
        text += '\n'
        if dataDict['核心水晶']:
        ...
        # 道具掉率
        self.appendLine(self.buildHeader(3, '道具掉率'))
